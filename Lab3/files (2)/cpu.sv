...
module cpu (
  ...
  mux5_2to1 reg2loc_mux (
    ...
    .i1(instr[4:0]),    // Rt/Rd (STUR's store data, CBZ's test register, BR's target register)
    .sel(Reg2Loc)
  );
  ...
  wire flags_neq, zero_taken, cond_taken;
  xor g_flags_neq  (flags_neq, N_flag, V_flag);
